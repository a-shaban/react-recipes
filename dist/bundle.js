 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(true){(function(){'use strict';var React=__webpack_require__(3);var _assign=__webpack_require__(5);var checkPropTypes=__webpack_require__(6);var scheduler=__webpack_require__(10);var tracing=__webpack_require__(13);/**
 * Use invariant() to assert state which your program assumes to be true.
 *
 * Provide sprintf-style format (only %s is supported) and arguments
 * to provide information about what broke and what you were
...
var _RecipeList = __webpack_require__(17);

var _RecipeList2 = _interopRequireDefault(_RecipeList);

var _RecipeDetail = __webpack_require__(18);

var _RecipeDetail2 = _interopRequireDefault(_RecipeDetail);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

fetch("http://reactrecipes.herokuapp.com" + '/v1/recipes').then(function (res) {
    return res.json();
}).then(function (json) {
...
var App = function App() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(_RecipeDetail2.default, { style: { flex: 5 } })
        )
    );
};
